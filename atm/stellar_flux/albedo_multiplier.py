...
input_file = "sflux-GJ436_greg.txt"  # Path to your input file
output_file = "sflux-GJ436_0.75_albedo_greg.txt"  # Path to save the output file
A = 0.75 # Albedo (1 - A), modify this value as needed
