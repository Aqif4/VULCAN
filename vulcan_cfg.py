...
out_name =  'Inhabited_Hycean_test.vul' # output file name
...
use_topflux = False
use_botflux = False
use_fix_sp_bot = {'CO2':0.001, 'H2O':0.015, 'CH4':5E-2} # fixed mixing ratios at the lower boundary
