...
P_b = 1e6 * 100  # pressure at the bottom (dyne/cm^2)  #SAVVAS: 1dyne/cm^2 = 1e-6 bar
...
use_topflux = False
use_botflux = False
use_fix_sp_bot ={}#{'CO2':0.001, 'H2O':0.015, 'CH4':5E-2} # fixed mixing ratios at the lower boundary if 0 flux get rid of.
