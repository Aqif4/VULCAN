...
sflux_file = 'atm/stellar_flux/sflux-GJ176_K2-18b_0.7_albedo.txt' # This is the flux density at the stellar surface
top_BC_flux_file = 'atm/BC_top.txt' # the file for the top boundary conditions
bot_BC_flux_file = 'atm/BC_bot_K218b_Wogan_nolife1.txt' # the file for the lower boundary conditions
vul_ini =  'output/Albedo_Surface/EQ/UH_K2-18b_GJ176_50bar_100metal_PT3.vul' # the file to initialize the abundances for ini_mix = 'vulcan_ini'
# output:
output_dir = 'output/Albedo_Surface/1e17/'
plot_dir = 'plot/'
movie_dir = 'plot/movie/'
out_name =  'UH_K2-18b_GJ176_0.7_albedo_50bar_1e17s_100metal_with_vdep.vul' # output file name
...
const_mix = {'CH4':1e-10, 'CO':1e-10, 'CO2': 0.008, 'O2':O_H*0.01, 'He':0.09691, 'H2O':0.1, 'N2':0.003, 'H2':0.85}
...
P_b = 1e6 * 50  # pressure at the bottom (dyne/cm^2)
...
use_topflux = False
use_botflux = True
use_fix_sp_bot =  {'H2O':2e-2, 'CO2':2e-3} #0.008(for VIH Wogan)} # fixed mixing ratios at the lower boundary
...
mtol = 1e-16 #1.E-20
mtol_conv = 1e-12 #1.E-18
pos_cut = 0
nega_cut = -1.
loss_eps = 1
yconv_cri = 0.00 # for checking steady-state
slope_cri = 1.e-4
yconv_min = 0.0
flux_cri = 0.1
...
post_conden_rtol = 2.5 # switched to this value after fix_species_time, was 2 greg suggested 2.5
