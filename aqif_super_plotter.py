...
vul_files = ['output/vuh_kzz/K2-18b_GJ176_nz250_1e13s_kzz_1e5.vul',
             'output/vuh_kzz/K2-18b_GJ176_nz250_1e17s_kzz_1e6.vul']
titles = ['1e5', '1e6'] 
plot_title = ''
# Titles for legend (now using file names)
...
# Define which dataset should have dotted lines
use_dotted = [False, True]  # True for datasets you want dotted, matching the order of vul_files
...
output_path = os.path.join(plot_dir, plot_name + '_overlay.png')
